...
void noFlagOCCSolver(int n1, int nvband, int ngpown, int ncouls, int *inv_igp_index, double *wx_array, GPPComplex *wtilde_array, GPPComplex *aqsmtemp, GPPComplex *aqsntemp, GPPComplex *I_eps_array, double *vcoul, GPPComplex *achtemp, GPPComplex *sch_array, GPPComplex *acht_n1_loc, GPPComplex *scha)
{
    GPPComplex expr0(0.00, 0.00);
    GPPComplex ssxt(0.00, 0.00);
    GPPComplex scht(0.00, 0.00);
